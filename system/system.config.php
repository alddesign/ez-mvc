...
[
    ...
    'base-url' => 'http://localhost/ez-mvc/',   //The url pointing to the root directory of EZ-MVC (where the index.php is located)
    ...
    'db-host' => '',                            //null or empty if not needed
    'db-port' => null,                          //null for default port 
    'db-user' => '',                            //null or empty for no user
    'db-password' => '',                        //null or empty for no password
